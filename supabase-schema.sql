...
-- Fixed-key media slots the admin panel manages directly: hero_video, hero_poster,
-- compare_before, compare_after, service_0 .. service_5
...
-- Individual frame URLs for canvas scroll-scrub sequences, in upload order.
alter table frame_sequences add column if not exists frame_urls text[];
...
insert into site_media (key, url) values
  ('hero_video', null), ('hero_poster', null),
  ('compare_before', null), ('compare_after', null),
  ('service_0', null), ('service_1', null), ('service_2', null),
  ('service_3', null), ('service_4', null), ('service_5', null),
  ('amenity_0', null), ('amenity_1', null), ('amenity_2', null),
  ('amenity_3', null), ('amenity_4', null)
